...
void configurarPinos() {
 ...
 // pinMode(ENTRADA_8, INPUT_PULLUP);
  BT_1.attach(ENTRADA_1, INPUT_PULLUP); // D36 -- 13
  BT_1.interval(25);

  BT_2.attach(ENTRADA_2, INPUT_PULLUP); // D39 -- 12
  BT_2.interval(25);

  BT_3.attach(ENTRADA_3, INPUT_PULLUP); // D32 -- 14
  BT_3.interval(25);

  BT_4.attach(ENTRADA_4, INPUT_PULLUP); // D33 -- 33
  BT_4.interval(25);

  BT_5.attach(ENTRADA_5, INPUT_PULLUP); // D25 -- 25
  BT_5.interval(25);

  BT_6.attach(ENTRADA_6, INPUT_PULLUP); // D26 -- 26
  BT_6.interval(25);

  BT_7.attach(ENTRADA_7, INPUT); //27 -- 27
  BT_7.interval(25);

  BT_8.attach(ENTRADA_8, INPUT_PULLUP); // D14 -- 21
  BT_8.interval(25);
